...
<body class="landing-page">
    ...
    <nav class="navbar navbar-expand-md navbar-dark top-nav-collapse default">
      <div class="container">
        <a class="navbar-brand" href="#">
          <img src="assets/images/logo.jpeg" alt="logo" style="max-width: 120px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li class="nav-item pe-1">
              <a class="nav-link" href="../dashboard/index.html">About</a>
            </li>
            <li class="nav-item pe-1">
              <a class="nav-link" href="../dashboard/index.html">Products</a>
            </li>
            <li class="nav-item pe-1">
              <a class="nav-link" href="../elements/bc_alert.html">Services</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-primary" target="_blank" href="https://codedthemes.com/item/mantis-bootstrap-admin-dashboard/">Contact</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-md-6 col-xl-4">
          <h1 class="mt-sm-3 text-white mb-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">Sekanca Media Digital</h1>
          <h5 class="mb-4 text-white opacity-75 wow fadeInUp" data-wow-delay="0.4s">Software House – Digital Solution for Modern Business</h5>
          <div class="my-5 wow fadeInUp" data-wow-delay="0.6s">
            <a href="../elements/bc_alert.html" class="btn btn-outline-primary me-2" target="_blank">Contact</a>
          </div>
        </div>
        <div class="col-lg-7">
          <img src="assets/images/landing/bg-mockup-theme-1.png" alt="img" class="img-fluid img-home-mokeup img-landing" data-img="assets/images/landing/bg-mockup-theme-" data-img-type=".png">
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container title">
      <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
        <div class="col-md-10 col-xl-6">
          <h2 class="my-3">Why Us?</h2>
          <p class="mb-0">Sekanca Media Digital is a software house focused on developing web applications and digital systems for businesses.</p>
        </div>
      </div>
    </div>
    <div class="container">
        ...
        <div class="col-sm-6 col-lg-4">
          <div class="card wow fadeInUp" data-wow-delay="0.4s">
            <div class="card-body">
              ...
              <p class="mb-0 text-muted">Sekanca has fully professional grade user interface for any kind of backend project.</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
          <div class="card wow fadeInUp" data-wow-delay="0.6s">
            <div class="card-body">
              ...
              <p class="mb-0 text-muted">Highly flexible to work.</p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-lg-4">
  ...
  <section class="pt-0">
    <div class="container title">
      <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
        <div class="col-md-10 col-xl-6">
          <h5 class="text-primary mb-0">Sekanca for All</h5>
          <h2 class="my-3">Complete Combo</h2>
          <p class="mb-0">Wheather you are developer or designer, Mantis serve the need of all - No matter you are novice or expert</p>
        </div>
      </div>
    </div>
    <div class="container">
  ...
  <section class="webapp-block">
    <div class="container title">
      <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
        <div class="col-md-10 col-xl-6">
          <h2 class="mb-3">Create Beautiful Yet Powerful web apps</h2>
          <p class="mb-0">Create your powerful project using powerful design system of Sekanca.
          </p>
        </div>
      </div>
    </div>
              ...
              <div class="d-flex">
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <p class="mb-2 text-muted">Fantastic design and good code
                    ...
                    components, page views, and authentication options. Definitely the best Ive found for Material UI in Typescript.</p>
            ...
            <div class="card-body">
              <div class="d-flex">
                ...
                <div class="flex-grow-1 ms-3">
                  ...
                  <p class="mb-2 text-muted">Excellent design, you can use in a new project or include in your current project. Multiple components for any use. Good code quality. Great customer service and support.</p>
  ...
  <footer class="footer bg-dark text-white">
    <div class="top-footer">
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            <img src="assets/images/pages/codedthemes-logo.svg" alt="image" class="img-fluid mb-3">
            <p>Since 2017, More than 50K+ Company's trust the Sekanca Digital Product. Sekanca is Manage under their Experienced Team Players.</p>
          </div>
          <div class="col-md-8">
            <div class="row">
              <div class="col-sm-4">
    ...
    <div class="bottom-footer">
      <div class="container">
        <div class="row align-items-center">
          <div class="col my-1">
            <p class="text-white mb-0">© Made with love by Team Sekanca</p>
          </div>
